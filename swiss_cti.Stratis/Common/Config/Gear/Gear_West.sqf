...
_i = _i		+ [["arifle_MX_Black_Hamr_pointer_F"]];
_u = _u		+ [1];
_p = _p		+ [30];
...
_i = _i		+ [["arifle_MX_GL_Black_Hamr_pointer_F"]];
_u = _u		+ [1];
_p = _p		+ [35];
...
_i = _i		+ ["H_RacingHelmet_2_F"];
_u = _u		+ [2];
_p = _p		+ [15];

_i = _i		+ ["H_RacingHelmet_1_blue_F"];
_u = _u		+ [2];
_p = _p		+ [15];
