...
switch (_script) do {
	...
	case "service-ammotruck": {_vehicle setVariable ["cti_spec", CTI_SPECIAL_AMMOTRUCK, true]; _vehicle setammocargo 100000}; // --- Ammo value probably needs tweaking, but should be considerably more than the pathetic default. Sari.
